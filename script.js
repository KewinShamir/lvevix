...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (!sessionStorage.getItem('introViu')) {
        setTimeout(() => { intro.style.opacity = '0'; content.classList.replace('hidden', 'show'); sessionStorage.setItem('introViu', 'true'); setTimeout(() => intro.style.display = 'none', 1000); }, 10000);
    } else { intro.style.display = 'none'; content.classList.replace('hidden', 'show'); }
